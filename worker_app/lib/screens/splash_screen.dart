...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin {
  ...
  Future<void> _startSequence() async {
    ...
    final String? workerToken = p.getString('worker_token');
    final bool isWorkerLogged = workerToken != null && workerToken.isNotEmpty;

    if (isWorkerLogged && mounted) {
      await context.read<WorkerProvider>().loadFromPrefs();
    }
    ...
    Navigator.pushReplacement(context, PageRouteBuilder(
      ...
      pageBuilder: (_, __, ___) => isWorkerLogged ? const WorkerHomeScreen() : const WorkerLoginScreen(),
