...
class _WorkerHomeScreenState extends State<WorkerHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // ── Loading guard: worker not yet loaded from prefs ──────
    if (worker == null) {
      return Scaffold(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Offline Mode — Showing cached data (check if laptop server is running)',
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: Stack(clipBehavior: Clip.none, children: [
              ...
              if (wp.pendingBookings.isNotEmpty)
                Positioned(
                  top: -4, right: -6,
                  child: Container(
                    padding: const EdgeInsets.all(3),
                    decoration: BoxDecoration(color: AppColors.error, shape: BoxShape.circle),
                    child: Text('${wp.pendingBookings.length}',
